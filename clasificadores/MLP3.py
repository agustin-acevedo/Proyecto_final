...
clasificador = neural_network.MLPClassifier(solver='adam', alpha=1e-5, learning_rate='invscaling',hidden_layer_sizes=(int(num_caract)), random_state=1, max_iter=10000)
