...
X_train = np.loadtxt("./datos/numero_caracteristicas" + str(num_caract) + "selector" + str(selector) + "/X_train.csv", delimiter=',')
y_train = np.loadtxt("./datos/numero_caracteristicas" + str(num_caract) + "selector" + str(selector) + "/y_train.csv", delimiter=',')
X_test = np.loadtxt("./datos/numero_caracteristicas" + str(num_caract) + "selector" + str(selector) + "/X_test.csv", delimiter=',')
y_test = np.loadtxt("./datos/numero_caracteristicas" + str(num_caract) + "selector" + str(selector) + "/y_test.csv", delimiter=',')
...
clasificador = neural_network.MLPClassifier(hidden_layer_sizes=(125,), max_iter=10000, alpha=1e-5, solver='adam', random_state=5)

#Escalamos
X_train = preprocessing.scale(X_train_balanced)
X_test = preprocessing.scale(X_test_balanced)
...
clasificador.fit(X_train, y_train_balanced)
